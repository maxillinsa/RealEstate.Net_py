 ...
 * terms; or (ii) using the files as included with a Microsoft SanPham subject
 * to that SanPham's license terms. Microsoft reserves all other rights to the
...
* standard jQuery library for all SanPhamion use.
*
